...
% Updated 2018-05-22  Michael Cai
%                     (For the purposes of continually updating the Rstar figures with new
%                     estimates)
...
% Update these!
vint = '190305';
quarter = '2018-12-31'; % Enter the current quarter (that is the last quarter for which we
...
suffix = ['_cond=none_para=full_vint=',vint,'.csv'];
...
load(fullfile(tvarTablespath, 'OutMod3forCharts'), 'qR_bar');
load(fullfile(tvarTablespath, 'OutMod3forCharts'), 'Time');
...
if makeDSGEFigures && makeTVARFigures
