...
m <= Setting(:data_vintage, "231023")
m <= Setting(:cond_vintage, "231023")
...
m <= Setting(:date_forecast_start,  quartertodate("2023-Q4"))
m <= Setting(:date_conditional_end, quartertodate("2023-Q4"))
