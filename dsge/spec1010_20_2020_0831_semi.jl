...
m <= Setting(:data_vintage, "200831")
m <= Setting(:cond_vintage, "200831")
m <= Setting(:cond_id, 9)
...
forecast_string = "rstar_0831_semi"
...
m <= Setting(:date_forecast_start,  quartertodate("2020-Q3"))
m <= Setting(:date_conditional_end, quartertodate("2020-Q3"))
