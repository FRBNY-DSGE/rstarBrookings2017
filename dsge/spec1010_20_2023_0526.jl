...
m <= Setting(:data_vintage, "230526")
m <= Setting(:cond_vintage, "230526")
...
m <= Setting(:date_forecast_start,  quartertodate("2023-Q2"))
m <= Setting(:date_conditional_end, quartertodate("2023-Q2"))
