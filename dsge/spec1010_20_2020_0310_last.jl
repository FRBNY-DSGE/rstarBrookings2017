...
m <= Setting(:cond_vintage, "200310")
m <= Setting(:cond_id, 12)
forecast_string = "post_system_last"
...
if run_forecast
    ...
    forecast_one(m, :mode, cond_type, output_vars; verbose = :high, forecast_string = forecast_string)

    # compute means and bands
    compute_meansbands(m, :mode, cond_type, output_vars, forecast_string = forecast_string)
