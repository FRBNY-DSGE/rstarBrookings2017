...
m <= Setting(:data_vintage, "200716")
m <= Setting(:cond_vintage, "200716")
m <= Setting(:cond_id, 9)
...
forecast_string = "rstar_0716_semi"
...
m <= Setting(:date_forecast_start,  quartertodate("2020-Q2"))
m <= Setting(:date_conditional_end, quartertodate("2020-Q2"))
...
if run_forecast
    ...
    @everywhere using OrderedCollections, DSGE, DataFrames
