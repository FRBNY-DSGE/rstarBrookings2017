...
m <= Setting(:data_vintage, "230227")
m <= Setting(:cond_vintage, "230227") # conditional data was pulled on 210516 for macro data, financial data on 210601
...
m <= Setting(:date_forecast_start,  quartertodate("2023-Q1"))
m <= Setting(:date_conditional_end, quartertodate("2023-Q1"))
...
if make_tables
    ...
    for input_type in input_types
      ...
      #  write_meansbands_tables_all(m, input_type, cond_type, [:shockdecobs, :trendobs, :dettrendobs], #typically pseudo
