...
m <= Setting(:data_vintage, "200410")
m <= Setting(:cond_vintage, "200416")
m <= Setting(:cond_id, 4) #5
...
forecast_string = "post_system_0410_expQ1Q2" #_full"
...
if run_forecast
    ...
    df = load_data(m, cond_type = cond_type, check_empty_columns = false)
