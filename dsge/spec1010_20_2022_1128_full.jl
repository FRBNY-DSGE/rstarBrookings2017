...
m <= Setting(:data_vintage, "221116")
m <= Setting(:cond_vintage, "221116") # conditional data was pulled on 210516 for macro data, financial data on 210601
...
m <= Setting(:date_forecast_start,  quartertodate("2022-Q4"))
m <= Setting(:date_conditional_end, quartertodate("2022-Q4"))
